      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <div className="mt-8 p-6 bg-dark-secondary rounded-lg border border-accent-green">
              <h4 className="text-lg font-semibold text-primary mb-3">Business Hours</h4>
              <div className="space-y-2 text-secondary">
                <div className="flex justify-between">
                  <span>Monday - Friday</span>
                  <span className="text-accent-green">24 Hours</span>
                </div>
                <div className="flex justify-between">
                  <span>Saturday</span>
                  <span className="text-accent-green">24 Hours</span>
              ...
              <div className="mt-4 p-3 bg-accent-green/10 rounded-lg border border-accent-green/30">
                <p className="text-accent-green text-sm font-medium">🌴 Bali Time Zone (WITA)</p>
        ...
        <div className="mt-16 bg-dark-secondary rounded-lg p-8 border border-accent-green">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-semibold text-primary mb-4">Quick Booking Inquiry</h3>
            <p className="text-secondary">Plan your Bali trip with us. Send us a message and we'll get back to you shortly</p>
          </div>
